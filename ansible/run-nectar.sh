...
ansible-playbook -i ./inventory/openstack_prod_inventory.py --private-key ~/.ssh/kazilast.pem --ask-become-pass playbook-prod-setup.yml
#ansible-playbook -i ./inventory/openstack_prod_inventory.py --private-key  ~/.ssh/gild-nectar.pem --ask-become-pass playbook-prod-setup.yml
